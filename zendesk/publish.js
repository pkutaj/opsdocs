...
async function publish() {
  ...
  for (const section of config.sections || []) {
    for (const art of section.articles || []) {
      ...
      const staticAssetsUrl = 'https://github.com/pkutaj/opsdocs/blob/master/assets/$2.$3?raw=true';
      ...
      if (hash !== art.hash) {
        ...
        art.webLink = `https://support.snowplowanalytics.com/hc/en-us/articles/${art.id}`
      }
    }
  }
